 ...
 * @author halilugur
 */
public class HsqlConnectionManager implements ConnectionManagerStrategy {

    private Connection connection;
    private final String URL_PREFIX = "jdbc:hsqldb:";
    ...
    public Connection doConnection(DBLoginModel loginModel) {
        ...
        if (!loginModel.getUrl().contains(loginModel.getDatabase())) {
            loginModel.setUrl(loginModel.getUrl() + "/" + loginModel.getDatabase());
        }
        try {
